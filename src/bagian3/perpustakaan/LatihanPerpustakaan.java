...
public class LatihanPerpustakaan {
    private ArrayList<LatihanBuku> koleksi = new ArrayList<>();

    public void tambahBuku(LatihanBuku buku) {
        koleksi.add(buku);
    }
    ...
    public void tampilkanKoleksi() {
        ...
        for (int i = 0; i < koleksi.size(); i++) {
            LatihanBuku b = koleksi.get(i);
            System.out.println((i + 1) + ". " + b.info());
        }
    }

    public void pinjamBuku(String judul) {
        for (LatihanBuku b : koleksi) {
